...
model = dict(
    ...
    backbone=dict(
        ...
        window_size=[None] * 12),
    decode_head=dict(num_classes=19, in_channels=[192, 192, 192, 192]),
    auxiliary_head=dict(num_classes=19, in_channels=192),
...
checkpoint_config = dict(by_epoch=False, interval=250, max_keep_ckpts=1)

evaluation = dict(interval=250, metric='mIoU', save_best='mIoU')
