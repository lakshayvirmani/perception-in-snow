...
train_file = os.path.join(output_dir, 'train_image_files.txt')
val_file = os.path.join(output_dir, 'val_image_files.txt')
test_file = os.path.join(output_dir, 'test_image_files.txt')
...
def collect_files(dir, output_file):
    ...
    for file in input_files:
        ...
        last_unit = split_units[-1].split('_')[0] + '.png'
