...
from cadcdscripts.helpers.version import version as VERSION

# annotation helper
from cadcdscripts.helpers.annotation import Point, Annotation, CsPoly
from cadcdscripts.helpers.labels import name2label, assureSingleInstanceName
